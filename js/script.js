...
function formarFrase() {
  ...
  var fraseCompleta = "Seu personagem principal é " + sorteioProtagonista + " " + sorteioProtagonista2 + ". Com o plot de " + sorteioPlot + ", no estilo " + sorteioEstilo + " e do gênero " + sorteioGenero + ".";
